...
errMsg.setTitle("Error:")
    .setColor(0xFF0040)
    .setDescription("Please enter in the form of `b!train [character first name] (alias)`!")
...
exports.help = (bot, msg, args) => {
    return "To bloom a card, please use the format of `b!train [character firstname] (alias)`.";
}
