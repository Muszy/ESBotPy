...
exports.run = (bot, msg, args) => {
	...
	file[msg.guild.id].bNotifyChannel = msg.channel.id;
	...
	let embed = new discord.RichEmbed();
	let channel = msg.guild.channels.get(file[msg.guild.id].bNotifyChannel);

	embed.setTitle("Confirmation:")
		.setColor(0x3399FF)
		.setThumbnail("http://i.imgur.com/7TL0t99.png")
		.setDescription("Bandori Notification channel is now: **" + channel.name + "**.");

	msg.channel.sendEmbed(embed).catch(console.error);
}

exports.help = (bot, msg, args) => {
	return "Use `bnotifyhere` to change the server notification channel.";
}
