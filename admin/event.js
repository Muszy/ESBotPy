...
exports.run = (bot, msg, args) => {
	...
	if( args[0].toLowerCase() == "name" ) {
		...
		embed.setTitle("Confirmation:")
			.setColor(0x3399FF)
			.setThumbnail("http://i.imgur.com/7TL0t99.png")
			.setDescription("Event name has been set to: `" + file["event"].name + "`");
		...
		embed.setTitle("Confirmation:")
			.setColor(0x3399FF)
			.setThumbnail("http://i.imgur.com/7TL0t99.png")
			.setDescription("Event desc has been set to: `" + file["event"].desc + "`");
		...
		embed.setTitle("Confirmation:")
			.setColor(0x3399FF)
			.setThumbnail("http://i.imgur.com/7TL0t99.png")
			.setDescription("Event img has been set to: `" + file["event"].img + "`");
		...
		embed.setTitle("Confirmation:")
			.setColor(0x3399FF)
			.setThumbnail("http://i.imgur.com/7TL0t99.png")
			.setDescription("Event url has been set to: `" + file["event"].url + "`");
