...
exports.run = (bot, msg, args) => {
	...
	if( args[0].toLowerCase() == "name" ) {
		...
		embed.setTitle("Confirmation:")
			.setColor(0x3399FF)
			.setThumbnail("http://i.imgur.com/7TL0t99.png")
			.setDescription("Gacha name has been set to: `" + file["gacha"].name + "`");
		...
		embed.setTitle("Confirmation:")
			.setColor(0x3399FF)
			.setThumbnail("http://i.imgur.com/7TL0t99.png")
			.setDescription("Gacha desc has been set to: `" + file["gacha"].desc + "`");
		...
		embed.setTitle("Confirmation:")
			.setColor(0x3399FF)
			.setThumbnail("http://i.imgur.com/7TL0t99.png")
			.setDescription("Gacha img has been set to: `" + file["gacha"].img + "`");
		...
		embed.setTitle("Confirmation:")
			.setColor(0x3399FF)
			.setThumbnail("http://i.imgur.com/7TL0t99.png")
			.setDescription("Gacha url has been set to: `" + file["gacha"].url + "`");
