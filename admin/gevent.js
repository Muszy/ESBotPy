...
exports.run = (bot, msg, args) => {
	...
	if( args[0].toLowerCase() == "name" ) {
		...
		embed.setTitle("Confirmation:")
			...
			.setDescription("Event name has been set to: `" + file["gEvent"].name + "`");
		...
		embed.setTitle("Confirmation:")
			.setColor(0x3399FF)
			.setThumbnail("https://gbf.wiki/images/d/dc/Stamp2.png")
			.setDescription("Event desc has been set to: `" + file["gEvent"].desc + "`");
		...
		embed.setTitle("Confirmation:")
			.setColor(0x3399FF)
			.setThumbnail("https://gbf.wiki/images/d/dc/Stamp2.png")
			.setDescription("Event img has been set to: `" + file["gEvent"].img + "`");
		...
		embed.setTitle("Confirmation:")
			.setColor(0x3399FF)
			.setThumbnail("https://gbf.wiki/images/d/dc/Stamp2.png")
			.setDescription("Event url has been set to: `" + file["gEvent"].url + "`");
		...
		embed.setTitle("Confirmation:")
			.setColor(0x3399FF)
			.setThumbnail("https://gbf.wiki/images/d/dc/Stamp2.png")
			.setDescription("GBF Event end has been reset.");
