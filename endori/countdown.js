...
exports.run = (bot, msg, args) => {
	if ( file["enEvent"].end != "" ) {
		...
		embed.setTitle("Event Countdown:")
		    .setColor(0xFFB400)
		    .setDescription("**" + days + " days " + hours + " hours " + minutes + " minutes " + seconds + " seconds** remaining for " + file["enEvent"].name + ".")
...
exports.help = (bot, msg, args) => {
	return "To get the current event countdown for Bandori, just use `countdown`.";
}
