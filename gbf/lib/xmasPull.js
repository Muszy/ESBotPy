...
var fs = require("fs");
var xmasPull = require("./xmasPull.js");
var scout = require("./../scout.js");

const pullURL = "https://raw.githubusercontent.com/Hanifish/Granblue/master/xmas.json";
            ...
            if (flip < 1) { //sr char
                request(pullURL, function(error, response, body) {
                    ...
                    if (!error) {
                        ...
                        xmasPull.tenPull(names, count + 1, msg);
                    }
