...
var fs = require("fs");
var grandPull = require("./grandPull.js");
var scout = require("./../scout.js");

const pullURL = "https://raw.githubusercontent.com/Hanifish/Granblue/master/grandfes.json";
            ...
            if (flip < 1) { //sr char
                request(pullURL, function(error, response, body) {
                    ...
                    if (!error) {
                        ...
                        grandPull.tenPull(names, count + 1, msg);
                    }
