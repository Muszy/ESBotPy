...
exports.run = (bot, msg, args) => {
	if (args.length < 1) {
		...
		embed.setTitle(":feet: About Me!")
			.setColor(0xB48CF0)
			.setDescription("I'm **DaikichiBot**! I was created by <@108752547166031872> for use by the Ensemble Stars Discord! If you need any help, go ahead and use `!help` or `!help [command]`!")
